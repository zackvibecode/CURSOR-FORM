...
export function AIFeatures() {
  return (
    <section id="features" className="bg-gradient-to-b from-gray-50 to-white py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-gray-500">
            Describe your business and what you want to collect. Our AI builds your WhatsApp form in
            seconds.
          </p>
        </ScrollReveal>

        <ScrollReveal className="mx-auto mb-20 max-w-2xl">
            ...
            <div className="rounded-xl bg-gradient-to-br from-gray-50 to-green-50/50 p-6 sm:p-8">
              <div className="mb-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  &ldquo;I run a cake shop and want to collect orders with pastry type, delivery
                  address, and phone number.&rdquo;
                </p>
              </div>
              ...
              <div className="rounded-xl border border-whatsapp/20 bg-white p-4 shadow-sm">
                ...
                <div className="space-y-2.5">
                  {["Your name", "Choose your pastry", "Delivery address", "Phone number"].map(
                    (field) => (
              ...
              <div className="mt-6 text-center">
                <Link href="/signup">
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 rounded-xl bg-whatsapp px-6 py-3 text-sm font-semibold text-white shadow-md transition-colors hover:bg-[#0DB849] active:scale-[0.98]"
                  >
                    <Sparkles className="h-4 w-4" />
                    Generate Form
                  </button>
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          ...
          <ScrollReveal delay={0.08}>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              ...
              <p className="text-sm text-gray-500">
                Choose from pre-designed templates, customize them in seconds, and start collecting
                responses instantly.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.16}>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              ...
              <p className="text-sm text-gray-500">
                Instantly transform your Google Forms into WhatsApp-friendly forms with just one
                click — quick, easy, and hassle-free!
              </p>
            </div>
          </ScrollReveal>
        </div>
