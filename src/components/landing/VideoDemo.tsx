  ...
  return (
    <section className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          className="relative mx-auto max-w-4xl overflow-hidden rounded-2xl border border-gray-200 bg-gray-900 shadow-card-lg"
              ...
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-800 via-gray-900 to-black">
                  ...
                  <button
                    ...
                    className="group relative z-10 flex h-20 w-20 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg shadow-whatsapp/30 transition-all hover:scale-110 hover:bg-[#0DB849] hover:shadow-xl hover:shadow-whatsapp/40 active:scale-95"
